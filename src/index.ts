      ...
      <body ng-app="dreamApp" ng-controller="MyController" ng-class="theme">
        <div class="header">
          ...
          <div style="margin-top: 20px;">
            <label>
              <input type="radio" ng-model="selectedOption" value="image" /> Image Generator
            </label>
            <label style="margin-left: 15px;">
              <input type="radio" ng-model="selectedOption" value="gif" /> Animated Image Generator
            </label>
          </div>
        ...
        <div class="content">
          ...
          <div class="image-container" ng-if="selectedOption === 'gif' && gifData">
            ...
            <div>
              <button ng-click="downloadGIF()">Download</button>
            </div>
          </div>
        </div>
        ...
        <script>
          angular.module('dreamApp', [])
            .controller('MyController', ['$scope', '$http', function($scope, $http) {
              ...
              $scope.typedText = "";
              $scope.selectedOption = "image"; // default
